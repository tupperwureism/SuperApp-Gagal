  ...
  return (
    <div className="w-full max-w-4xl mx-auto my-8 z-40 animate-fade-in px-4">
      ...
      <div className="preview-card-gateway">
        ...
        {/* INNER SAFE-ZONE WRAPPER (Guaranteed physical 32px-56px margin from all outer walls) */}
        <div className="relative z-20 p-8 sm:p-12 md:p-14 flex flex-col gap-8">
          {/* Header Bar */}
          <div className="flex items-center justify-between pb-5 border-b border-white/[0.08] pt-2">
            ...
            <button
              type="button"
              onClick={onClose}
              className="flex items-center gap-2 text-xs sm:text-sm text-slate-300 hover:text-white cursor-pointer font-bold px-3.5 py-1.5 rounded-xl bg-white/[0.05] hover:bg-white/[0.12] border border-white/[0.08] transition-all shadow-sm shrink-0"
            >
