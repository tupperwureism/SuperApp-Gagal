...
export const PortalCardItem: React.FC<PortalCardItemProps> = ({
  ...
  return (
    <Card className="flex flex-col justify-between p-0 rounded-3xl border border-white/15 bg-slate-900/90 backdrop-blur-2xl shadow-2xl min-h-[500px] h-full relative overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:border-white/40 hover:shadow-[0_25px_60px_rgba(0,0,0,0.7)] group">
      ...
      {/* SINGLE MASTER INNER CONTAINER: pt-10 pb-8 px-8 sm:px-10 xl:px-12 ensures 40px top padding below the stripe, 32-48px left & right padding, and 32px bottom padding. Zero mepet, zero clipping! */}
      <div className="pt-10 pb-8 px-8 sm:px-10 xl:px-12 flex flex-col justify-between flex-1 gap-6 relative z-10 w-full">
        {/* HEADER SECTION */}
