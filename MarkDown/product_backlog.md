...
| **ST-J-15** | J-UC16 | **Sebagai Admin Legal Justifiqa**, saya ingin memverifikasi dokumen kredensial advokat (SIPP/Peradi) dan keabsahan SKTM Pro Bono klien, **sehingga** integritas platform terjamin.<br>**Acceptance Criteria:** (1) Panel admin memfasilitasi pengecekan langsung ke pangkalan data Mahkamah Agung / Peradi; (2) Setiap kepuputusan (Approve/Reject) wajib mencatat alasan dan menyimpan hash transaksional ke storage WORM. | 5 | High |
