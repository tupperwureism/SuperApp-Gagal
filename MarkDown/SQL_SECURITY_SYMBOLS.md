...
| policy | rls_advocate_reviews_client_submit ON public.advocate_reviews | S/20260721000010_align_frontend_schema_contracts.sql:L470 +1 |
...
| policy | rls_advocate_reviews_public_read ON advocate_reviews | S/20260715000002_domain2_consultation_fairclock_sla.sql:L187 |
| policy | rls_advocate_sanctions_advocate_read ON advocate_sanctions_log | S/20260715000001_domain1_identity_rbac_licensing.sql:L247 |
...
| policy | rls_advocate_service_tiers_advocate_manage ON public.advocate_service_tiers | S/20260721000010_align_frontend_schema_contracts.sql:L333 +1 |
| policy | rls_advocate_service_tiers_public_read ON advocate_service_tiers | S/20260715000001_domain1_identity_rbac_licensing.sql:L211 |
...
| policy | rls_audit_logs_worm_self_read ON audit_logs_worm | S/20260715000005_domain5_probono_disputes_worm_audit.sql:L139 |
...
| policy | rls_booking_sessions_advocate_access ON booking_sessions | S/20260715000002_domain2_consultation_fairclock_sla.sql:L87 |
...
| policy | rls_booking_sessions_client_access ON booking_sessions | S/20260715000002_domain2_consultation_fairclock_sla.sql:L81 |
...
| policy | rls_case_irac_advocate_read ON public.case_irac_notes | S/20260721000010_align_frontend_schema_contracts.sql:L385 +1 |
...
| policy | rls_chat_sessions_metadata_participants ON chat_sessions_metadata | S/20260715000002_domain2_consultation_fairclock_sla.sql:L148 |
...
| policy | rls_consultation_slots_advocate_manage ON public.consultation_slots | S/20260721000010_align_frontend_schema_contracts.sql:L321 +1 |
| policy | rls_consultation_slots_public_read ON consultation_slots | S/20260715000002_domain2_consultation_fairclock_sla.sql:L36 |
...
| policy | rls_dispute_cases_participant_read ON public.dispute_cases | S/20260721000010_align_frontend_schema_contracts.sql:L398 +1 |
...
| policy | rls_dispute_signatures_mediator_read ON public.dispute_mediator_signatures | S/20260721000010_align_frontend_schema_contracts.sql:L593 +1 |
...
| policy | rls_document_revisions_participant_access ON document_revisions | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L98 |
...
| policy | rls_emeterai_public_verify ON emeterai_stamping_logs | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L131 |
| policy | rls_escrow_transactions_advocate_read ON public.escrow_transactions | S/20260721000015_harden_verified_advocate_rls_helper.sql:L23 +2 |
| policy | rls_escrow_transactions_client_read ON escrow_transactions | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L57 |
...
| policy | rls_governance_configs_public_read ON platform_governance_configs | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L182 |
...
| policy | rls_legal_opinions_advocate_access ON legal_opinions | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L71 |
...
| policy | rls_legal_opinions_client_access ON legal_opinions | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L65 |
...
| policy | rls_offline_handshakes_participant_access ON offline_handshakes_totp | S/20260715000002_domain2_consultation_fairclock_sla.sql:L114 |
...
| policy | rls_payout_ledgers_wallet_owner_read ON public.escrow_payout_ledgers | S/20260728000025_phase2_backend_forensic_hardening.sql:L989 +1 |
| policy | rls_probono_cases_client_insert ON public.probono_cases | S/20260721000010_align_frontend_schema_contracts.sql:L482 |
| policy | rls_probono_cases_client_read ON probono_cases | S/20260715000005_domain5_probono_disputes_worm_audit.sql:L35 |
...
| policy | rls_sipp_verifications_advocate_read ON sipp_verifications | S/20260715000001_domain1_identity_rbac_licensing.sql:L182 |
...
| policy | rls_tax_pph21_advocate_read ON tax_pph21_withholdings | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L160 |
| policy | rls_user_active_devices_self_manage ON user_active_devices | S/20260715000001_domain1_identity_rbac_licensing.sql:L142 |
| policy | rls_user_notifications_self_read ON user_notifications | S/20260715000005_domain5_probono_disputes_worm_audit.sql:L169 |
...
| policy | rls_users_admin_internal_access ON users_admin | S/20260715000001_domain1_identity_rbac_licensing.sql:L114 |
...
| policy | rls_users_advocate_public_read ON users_advocate | S/20260715000001_domain1_identity_rbac_licensing.sql:L83 |
| policy | rls_users_advocate_self_update ON public.users_advocate | S/20260721000010_align_frontend_schema_contracts.sql:L285 +1 |
| policy | rls_users_client_self_access ON users_client | S/20260715000001_domain1_identity_rbac_licensing.sql:L42 |
...
| policy | rls_wallet_balances_self_read ON wallet_balances | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L90 |
...
| trigger | trg_worm_advocate_sanctions_vault ON public.advocate_sanctions_log | S/20260716000006_domain_hardening_worm_and_acid_mutex.sql:L22 |
| trigger | trg_worm_audit_logs_vault ON public.audit_logs_worm | S/20260721000011_fix_plpgsql_mutex_and_worm_functions.sql:L33 +1 |
| trigger | trg_worm_case_irac_notes ON case_irac_notes | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L174 |
...
| trigger | trg_worm_dispute_signatures_vault ON public.dispute_mediator_signatures | S/20260716000006_domain_hardening_worm_and_acid_mutex.sql:L29 |
...
| trigger | trg_worm_emeterai_stamping_logs ON public.emeterai_stamping_logs | S/20260721000011_fix_plpgsql_mutex_and_worm_functions.sql:L27 +1 |
| trigger | trg_worm_escrow_payout_ledgers_vault ON public.escrow_payout_ledgers | S/20260716000006_domain_hardening_worm_and_acid_mutex.sql:L36 |
