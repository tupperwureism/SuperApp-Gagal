...
| **UC-12** | Mengeluarkan Output Dokumen Konsultasi | Mitra | [B.UC-12](unified_use_case_scenarios.md#b-aktor-mitra-profesional-professional-partner) | **AD-Kes-04, AD-Psi-05, AD-Huk-04** | **SD-14** | Modul Medis/Psi/Hukum | ST-012 | Domain-specific | PDF(Permenkes73/IRAC), EMeterai(Huk), SIAExport(Kes) |
...
| **UC-17** | Mengelola Saldo & Penarikan Dana Mitra | Mitra + Admin Fin | [B.UC-17](unified_use_case_scenarios.md#b-aktor-mitra-profesional-professional-partner) | AD-11 | **SD-18** | Dashboard Mitra (#mockup_dashboard_mitra) | ST-026 | UU PDP, PSAK 71 | NPWP/BPJS(Kes), Escrow(Huk), Threshold |
