...
- 339 exported TypeScript symbols dalam 187 files.
- 126 core PostgreSQL objects dari 322 deklarasi migrasi.
...
| components/client/CheckoutEscrowModal.tsx | 25v CheckoutEscrowModal |
...
| components/client/ClientTabNav.tsx | 18f ClientTabNav |
...
| components/corporate/BeneficialOwnerFields.tsx | 69f BeneficialOwnerFields |
...
| pages/ClientDashboardPage.tsx | 18v ClientDashboardPage |
| pages/ClientDisputeCenterPage.tsx | 7f ClientDisputeCenterPage |
| pages/DevShowcasePage.tsx | 14f DevShowcasePage |
...
| services/corporateEvidenceService.ts | 3t EvidenceUploadStep, 5t EvidenceUploadOutcome, 9c CorporateEvidenceError, 31f uploadBeneficialOwnerEvidence, 44f uploadBeneficialOwnerEvidenceWithIds |
...
| services/phase2SupabaseGateway.ts | 62v phase2SupabaseGateway, 282v phase2IntegrationService |
...
| function | public.fn_book_consultation_slot_mutex( p_slot_id UUID, p_case_summary TEXT, p_booking_ty… | S/20260722000016_p2_b3_service_orders_expand_only.sql:L11 +3 |
...
| function | public.fn_mutate_wallet_balance_mutex( p_wallet_id UUID, p_amount NUMERIC, p_mutation_typ… | S/20260721000011_fix_plpgsql_mutex_and_worm_functions.sql:L92 +2 |
...
| function | public.fn_prevent_worm_mutation() | S/20260721000011_fix_plpgsql_mutex_and_worm_functions.sql:L9 +3 |
...
| function | public.fn_record_immutable_audit_log( p_actor_user_id UUID, p_actor_type VARCHAR, p_actio… | S/20260721000011_fix_plpgsql_mutex_and_worm_functions.sql:L212 +2 |
| function | public.fn_refund_escrow_to_client_mutex( p_escrow_id UUID, p_refund_reason TEXT ) | S/20260721000011_fix_plpgsql_mutex_and_worm_functions.sql:L149 +2 |
...
| function | public.fn_release_escrow_to_advocate_mutex( p_escrow_id UUID ) | S/20260728000025_phase2_backend_forensic_hardening.sql:L419 +3 |
...
| table | advocate_reviews | S/20260715000002_domain2_consultation_fairclock_sla.sql:L162 |
| table | advocate_sanctions_log | S/20260715000001_domain1_identity_rbac_licensing.sql:L225 |
| table | advocate_service_tiers | S/20260715000001_domain1_identity_rbac_licensing.sql:L190 |
| table | audit_logs_worm | S/20260715000005_domain5_probono_disputes_worm_audit.sql:L117 |
| table | booking_sessions | S/20260715000002_domain2_consultation_fairclock_sla.sql:L50 |
| table | case_irac_notes | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L145 |
| table | chat_sessions_metadata | S/20260715000002_domain2_consultation_fairclock_sla.sql:L128 |
| table | consultation_slots | S/20260715000002_domain2_consultation_fairclock_sla.sql:L11 |
| table | dispute_cases | S/20260715000005_domain5_probono_disputes_worm_audit.sql:L43 |
| table | dispute_mediator_signatures | S/20260715000005_domain5_probono_disputes_worm_audit.sql:L85 |
| table | document_revisions | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L80 |
| table | emeterai_stamping_logs | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L112 |
| table | escrow_payout_ledgers | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L98 |
| table | escrow_transactions | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L12 |
| table | legal_opinions | S/20260715000004_domain4_legal_opinions_worm_emeterai.sql:L27 |
| table | offline_handshakes_totp | S/20260715000002_domain2_consultation_fairclock_sla.sql:L96 |
| table | platform_governance_configs | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L168 |
| table | probono_cases | S/20260715000005_domain5_probono_disputes_worm_audit.sql:L12 |
...
| table | sipp_verifications | S/20260715000001_domain1_identity_rbac_licensing.sql:L151 |
| table | tax_pph21_withholdings | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L137 |
| table | user_active_devices | S/20260715000001_domain1_identity_rbac_licensing.sql:L122 |
| table | user_notifications | S/20260715000005_domain5_probono_disputes_worm_audit.sql:L153 |
| table | users_admin | S/20260715000001_domain1_identity_rbac_licensing.sql:L97 |
| table | users_advocate | S/20260715000001_domain1_identity_rbac_licensing.sql:L51 |
| table | users_client | S/20260715000001_domain1_identity_rbac_licensing.sql:L14 |
| table | wallet_balances | S/20260715000003_domain3_escrow_tax_ledgers_acid.sql:L70 |
